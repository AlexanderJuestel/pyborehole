...
We welcome and encourage everyone to contribute to PyBorehole! 
...
please [search the existing issues for related questions](https://github.com/AlexanderJuestel/pyborehole/issues).
If your question has not already been asked, then [make a new issue](https://github.com/AlexanderJuestel/pyborehole/issues/new/choose).

### Reporting Bugs

Please report bugs on the [issue page using the bug report template](https://github.com/AlexanderJuestel/pyborehole/issues/new?assignees=&labels=&template=bug_report.md&title=) and label the issue as a bug.
...
this please create an issue on the
 [issue page](https://github.com/AlexanderJuestel/pyborehole/issues) with the *Feature 
...
then please [open the issue](https://github.com/AlexanderJuestel/pyborehole/issues/new/choose) 
...
[a LGPL-3 license](https://github.com/AlexanderJuestel/pyborehole/blob/main/LICENSE).
...
You must complete the checklist in the [PR template](https://github.com/AlexanderJuestel/pyborehole/blob/main/PULL_REQUEST_TEMPLATE.md) before we will review the PR and consider merging your contribution.
